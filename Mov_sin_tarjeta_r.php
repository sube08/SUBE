    ...
    <div id="frm">
        ...
        <table style="max-width:100%">
            <div id="divMenu" class="icon-bar">
                ...
                <a class="active" href="Mov_sin_tarjeta.php" title="AGREGA REGISTRO MANUAL" name="addManual" id="addMaual"><i class="fa fa-pencil-square-o"></i></a>
                <a href="EditarUsuario.php" title="BUSCAR" id="bscUsuarios" name="bscUsuarios"><i class="fa fa-search"></i></a>
        ...
        <form id="idFormRegMov" name="idFormRegMov" method="GET" action="funciones.php" style="max-width:100%">
                ...
                <div class="row" style="width:50%">
                    <div class="col">
                        ...
                        <div class="input-group">
                            ...
                            <input id="idRutMM" name="idRutMM" type="text" maxlength="12" placeholder="Ej. 18.773.566-6" class="form-control form-control-sm" style="width:200px" onkeyup="blurRutField(this)" onblur="CargaBicicletas(this)" />
                        </div>
                    </div>
                </div>
                &nbsp;
            ...
            <center>  <input type="button" id="idRealizarMovimiento" name="idRealizarMovimiento" class="btn btn-primary" onclick="valida_enviaF()" style="width: 180px" value="Guardar" /></button> </center>
